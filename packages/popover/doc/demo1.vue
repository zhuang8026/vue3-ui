...
<template>
  <m-popover class="space" trigger="hover" placement="top-start" content="hover激活">
    <template #reference>
      <atd-button size="medium">hover激活</atd-button>
    </template>
  </m-popover>
  ...
  <m-popover class="space" trigger="focus" placement="right" content="focus激活">
    <template #reference>
      <atd-button size="medium">focus激活</atd-button>
    </template>
  </m-popover>
  <m-popover class="space" trigger="manual" v-model="visible" placement="bottom-end" content="手动激活">
    <template #reference>
      <atd-button size="medium" @click="handler">手动激活</atd-button>
    </template>
  </m-popover>
</template>
<script setup>
