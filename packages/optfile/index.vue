<template>
  <div :class="['mzl-optfile-default', customClass]">
    ...
    <div class="mzl-preview-img-box">
      ...
      <atd-button :type="type" :leftIcon="icon" @click="changeFile" v-if="targetType == 'btn'">{{ label }}</atd-button>
      <div
        :class="['mzl-optfie-area', { 'mzl-optfie-area-big': size == 'big', 'mzl-opfile-area-active': activeFile }]"
        v-if="targetType == 'box'"
        ref="refDiv"
      >
