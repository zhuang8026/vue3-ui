<template>
  <div :class="['atd-textarea-default', customClass, { 'atd-textarea-disabled': disabled }]">
    <textarea
      :form="form"
      :cols="cols"
      :rows="rows"
