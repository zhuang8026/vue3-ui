    ...
    <div :class="['mzl-confirm', customClass]" v-if="isShow">
      <div class="mzl-wrapper">
        ...
        <div class="mzl-footer">
          <atd-button @click="cancelCallback" size="small" style="margin-right: 10px" v-if="cancelShow">{{
            cancelText
          }}</atd-button>
          <atd-button @click="confirmCallback" size="small" type="primary" v-if="confirmShow">{{
            confirmText
          }}</atd-button>
        </div>
      </div>
