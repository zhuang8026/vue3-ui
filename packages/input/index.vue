<template>
  <div :class="[`atd-group-input-${size}`]" :style="{ 'min-width': 'auto' }">
...
const isClass = computed(() => {
  return [
    props.clearable ? 'atd-input-clearable' : props.size == 'default' ? 'atd-input-default' : `atd-input-${props.size}`,
    props.leftIcon != ''
      ? `atd-input-left-icon-${props.size}`
      : !props.clearable
      ? props.rightIcon != ''
        ? `atd-input-right-icon-${props.size}`
        : ''
      : '',
    props.disabled ? 'atd-input-disabled' : '',
    props.type == 'password'
      ? props.showPassword
        ? `atd-input-password-showpassword-${props.size}`
        : `atd-input-password-${props.size}`
      : ''
  ];
});
</script>
...
.atd-input-default,
.atd-input-password-default,
.atd-input-password-showpassword-default,
.atd-group-input-default {
  width: 100%;
  height: 35px;
...
.atd-input-small,
.atd-input-password-small,
.atd-input-password-showpassword-small,
.atd-group-input-small {
  width: 100%;
  height: 30px;
  border: 1px solid #dcdfe6f6;
  overflow: hidden;
...
.atd-input-mini,
.atd-input-password-mini,
.atd-input-password-showpassword-mini,
.atd-group-input-mini {
  width: 100%;
  height: 28px;
  border: 1px solid #dcdfe6f6;
  overflow: hidden;
...
.atd-group-input-default :deep(.atd-button) {
  padding: 9px 20px !important;
  border-radius: 0 2px 2px 0;
}
.atd-group-input-small :deep(.atd-button) {
  padding: 6.6px 15px !important;
  border-radius: 0 2px 2px 0;
}
.atd-group-input-mini :deep(.atd-button) {
