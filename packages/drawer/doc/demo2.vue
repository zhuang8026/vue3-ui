...
<template>
  <m-space>
    <atd-button @click="openDrawerOfLeft">左边-left</atd-button>
    <atd-button @click="openDrawerOfTop">上边-top</atd-button>
    <atd-button @click="openDrawerOfRight">右边-right</atd-button>
    <atd-button @click="openDrawerOfBottom">下边-bottom</atd-button>
  </m-space>
