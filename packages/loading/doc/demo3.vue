...
<template>
  <m-space>
    <atd-button @click="openLoading">點擊加載</atd-button>
  </m-space>
  <div id="loadingTextBox">
    <m-table :options="options" size="small">
      <template #action>
        <atd-button type="text" leftIcon="m-icon-edit" size="small">編輯</atd-button>
        <atd-button type="text" leftIcon="m-icon-ashbin" style="color: #ec3437" size="small">刪除</atd-button>
      </template>
    </m-table>
  </div>
</template>
