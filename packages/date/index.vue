<template>
  <div :class="['mzl-date-box','mzl-date-default']" v-click-outside>
    <div class="mzl-date-inner-box">
      <atd-input v-model="dateVal" leftIcon="m-icon-calendar" @clear="clear" :size="size" :clearable="clearable" readonly :placeholder="placeholders" :disabled="disabled" :focusColor="customActiveColor" :form="form"></atd-input>
